        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mb-14 flex items-end justify-between">
            ...
            <div className="hidden items-center gap-2 border border-border bg-surface/50 rounded-xl px-4 py-2 text-xs mono text-muted sm:flex select-none">
              <TrendingUp size={14} className="text-accent" /> Iterative
              progress flow
            </div>
          </div>
            ...
            {LOOP.map((step, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={`absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-[0.03] transition-opacity duration-300 pointer-events-none bg-current ${step.color}`}
                  />

                  <div>
                    {/* Header: Number & Icon */}
                    <div className="flex items-center justify-between mb-6">
                      <span className="mono text-xs font-bold text-muted-2">
                        0{idx + 1}
                      </span>
                      <div
                        className={`h-8 w-8 rounded-lg flex items-center justify-center border transition-colors duration-300 ${step.bgAccent} ${step.color}`}
                      >
          ...
          <div className="relative overflow-hidden rounded-3xl border border-border bg-surface/25 backdrop-blur-md px-8 py-16 text-center shadow-xl">
            ...
            <div className="relative z-10 flex flex-col items-center">
              ...
              <p className="mt-4 max-w-lg text-[13.5px] sm:text-[14px] leading-relaxed text-muted font-medium">
                Six lessons, one deterministic simulation engine, zero AI
                guessing at your architecture&apos;s physics.
              </p>
              ...
              <Link href="/learn/client-server-db" className="mt-8 group">
                <Button
                  size="lg"
                  className="font-bold tracking-tight hover:shadow-[0_0_20px_rgba(52,211,153,0.3)]"
                >
                  Start Lesson 1
                  <ArrowRight
                    size={14}
